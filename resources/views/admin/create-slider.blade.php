            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="row g-3">
                    <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12">
                        <div class="card mt-3">
                            <div class="card-body">
                                <h5>Create Slider Item</h5>
                            </div>
                            <div class="card-body">
                                <form class="" method="post" action="{{ route('admin.slider.save') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row g-3">
                                        <div class="col-5">
                                            <label for="TextInput" class="form-label">Slider Item Name</label>
                                            <input type="text" class="form-control" name="name" placeholder="Slider Item Name" required/>
                                        </div>
                                        @error('name')
