            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="row g-3">
                    <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12">
                        <div class="card mt-3">
                            <div class="card-body">
                                <h5>Create Govt. Order</h5>
                            </div>
                            <div class="card-body">
                                <form class="" method="post" action="{{ route('admin.gos.save') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row g-3">
                                        <div class="col-lg-2">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="date" class="form-control" name="go_date" required/>
                                            @error('go_date')
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="number" class="form-control" name="order_by" placeholder="0" required/>
                                            @error('order_by')
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="go_notification_number" placeholder="Notification" required/>
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <input type="text" class="form-control" name="go_subject" placeholder="Subject" required/>
                                            @error('go_subject')
